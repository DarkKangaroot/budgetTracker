...
<template>
  <el-carousel ref="sliderRef" :interval="4000" type="card" :autoplay="false" height="800px">
    <el-carousel-item v-for="(header, index) in budgetData" :key="index">
      <el-card class="overflow-auto">
        <el-form label-position="top" v-if="header.isEditHeader">
        ...
        <div class="grid grid-cols-1 gap-2 mb-5" v-else>
          <div class="flex flex-wrap justify-between">
            ...
            <el-button-group>
              ...
              <el-button type="primary" @click="header.isEditHeader = !header.isEditHeader" :icon="Edit"/>
              <el-popconfirm 
                  width="220" 
        ...
        <div class="flex flex-wrap justify-between mt-5 mb-5">
          ...
          <el-button type="primary" @click="header.isEditDetails = !header.isEditDetails" :icon="(header.isEditDetails ? Check : Edit)" circle/>
        </div>
        ...
        <el-table 
          :data="header.details" height="400px"
          >
          <el-table-column prop="name" label="Name">
            <template #default="scope">
              <el-input v-model="scope.row.name" v-if="header.isEditDetails" />
          ...
          <el-table-column prop="" label="">
            <template #header>
              <el-button type="primary" :icon="Plus" circle @click="addNewDetails(index)" v-if="header.isEditDetails"/>
            </template>
            <template #default="scope">
